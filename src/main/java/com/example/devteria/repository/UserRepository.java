...
//JPA tự động generate code trong interface
    ...
    boolean existsByUsername(String userName);  //khi ta khai báo hàm này, Spring JPA tự động generate một câu query kiểm tra tồn tại của field userName này với value là username mà ta truyền vào mà ko cần phải code dòng nào
}
